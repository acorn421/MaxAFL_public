...
static void edit_params(u32 argc, char **argv)
{
  ...
  // cc_params[cc_par_cnt++] = "-load";
  // cc_params[cc_par_cnt++] = "-Xclang";
  // cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-cmp-pass.so", obj_path);
  // cc_params[cc_par_cnt++] = "-Xclang";
  // cc_params[cc_par_cnt++] = "-load";
  // cc_params[cc_par_cnt++] = "-Xclang";
  // cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-analysis-pass.so", obj_path);

  // cc_params[cc_par_cnt++] = "-mllvm";
  // cc_params[cc_par_cnt++] = "-inline";
  ...
  cc_params[cc_par_cnt++] = "-load";
  cc_params[cc_par_cnt++] = "-Xclang";
  cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-pass.so", obj_path);
#endif /* ^USE_TRACE_PC */
  ...
  // ! make AFL_DONT_OPTIMIZE as default option.
  ...
  if (!getenv("AFL_DONT_OPTIMIZE"))
  {
    ...
    // cc_params[cc_par_cnt++] = "-mllvm";
    // cc_params[cc_par_cnt++] = "-debug-pass=Arguments";
    // cc_params[cc_par_cnt++] = "-mllvm";
    // cc_params[cc_par_cnt++] = "-disablepass=simplifycfg";
  ...
  if (maybe_linking)
  {
    ...
    case 0:
      ...
      // cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-rt.o", obj_path);
      break;

    case 32:
      cc_params[cc_par_cnt++] = alloc_printf("%s/afl-llvm-rt-32.o", obj_path);
      // cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-rt-32.o", obj_path);
    ...
    case 64:
      ...
      // cc_params[cc_par_cnt++] = alloc_printf("%s/maxafl-rt-64.o", obj_path);
